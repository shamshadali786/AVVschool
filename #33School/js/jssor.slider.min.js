...
!(function (i, h, m, f, d, k, e) {
    ...
    g = (i.$Jease$ = {
      ...
      $InOutElastic: function (a) {
        ...
        var b = 0.45,
          d = 0.1125;
        return (a *= 2) < 1
          ? -0.5 * c.v(2, 10 * (a -= 1)) * c.pb(((a - d) * 2 * c.E) / b)
          : c.v(2, -10 * (a -= 1)) * c.pb(((a - d) * 2 * c.E) / b) * 0.5 + 1;
      },
      $InBack: function (a) {
        var b = 1.70158;
        return a * a * ((b + 1) * a - b);
  ...
  var b = (i.$Jssor$ = new (function () {
    ...
    function Gb() {
      if (!L) {
        L = { Hc: "ontouchstart" in i || "createTouch" in h };
        var a;
    ...
    function cb(a) {
      ...
      return function (g) {
        if (!b) {
          ...
          l(
            [a].concat(["WebKit", "ms", "Moz", "O", "webkit"]),
            function (h, d) {
              var b = a;
              if (d) b = h + f;
    ...
    var S = { $Top: f, $Right: f, $Bottom: f, $Left: f, I: f, G: f };
    j.Hg = function (a) {
      var b = j.Rb();
      s(b, { Rd: "block", Ob: j.wb(a), $Top: 0, $Left: 0, I: 0, G: 0 });
      var d = j.Nd(a, S);
      j.tb(b, a);
      j.J(b, a);
      var e = j.Nd(a, S),
    ...
    j.Zc = function (c, d) {
      ...
      if (c)
        if (b.qe(c)) a = { X: a };
        else if (b.qe(c.$Clip)) a.$Clip = { X: c.$Clip };
      a.X = a.X || d;
  ...
  i.$JssorBulletNavigator$ = function () {
    ...
    a.B = function (d, c) {
      ...
      a.dd = g = b.F({ $SpacingX: 10, $SpacingY: 10, $ActionMode: 1 }, c);
  ...
  var t = (i.$JssorCaptionSlideo$ = function () {
      ...
      function db(o, p, g) {
        ...
        b.c(p, function (h) {
          ...
          var m = { $Easing: i, $OriginalWidth: g.I, $OriginalHeight: g.G },
          ...
          if (f.Ab) g.Ab = { Fd: 0, Ad: 0, Od: 0, $Opacity: 0 };
          g = b.Re(g, f);
        });
        if (a && e) {
          e.Je();
          ...
          if (a.ub < m) {
            ...
            j = new l(a.ub, n - i, { lc: n - a.ub, bf: d });
            j.W(e, d);
          }
          h && a.Vc.push(h);
          j && a.wd.push(j);
    ...
    j = (i.$JssorSlider$ = (i.module || {}).exports = function () {
      ...
      function Rc(e, h, o) {
        ...
        l.$ScaleSize = function (q, l, u) {
          ...
          if (!f) {
            f = b.Hg(e);
            g = e.parentNode;
            j = { $Scale: b.q(e, n.af, 1), $AutoCenter: b.q(e, n.Eb) };
            b.c(m, function (c, a) {
      ...
      function dd() {
        ...
        l.call(
          ...
          -1,
          2,
          { $Easing: g.$Linear, mf: { Ob: Dc }, lc: q, $Reverse: Hb },
          b,
          { Ob: 1 },
          { Ob: -2 }
        );
      ...
      function cd(w, h) {
        var g = this,
          ...
          z,
          S;
        l.call(g, -N, N + 1, { lc: C & 1 ? q : e, $Reverse: Hb });
        function K() {
          y && y.$Destroy();
          Wb -= G;
          G = 0;
          y = new cb.$Class(u, cb, { $Idle: b.q(u, "idle", sc), pg: !t });
          y.$On(p.vc, X);
        }
        function Y() {
          y.sd < cb.sd && K();
      ...
      function Hc(f) {
        if (Ib()) {
          ...
          a = xb(a + e, 0.5);
          var d = c.H(a - b);
          if (d < 1 && m.$SlideEasing != g.$Linear) d = c.v(d, 0.5);
          if ((!db || !f) && Mb) y.Gc(hc);
          else if (b == a) tc.zc();
          else y.bd(b, a, d * Gb);
        }
      ...
      a.B = function (i, f) {
        ...
        I = m.$SlideWidth || zb;
        H = m.$SlideHeight || yb;
        gb = { I: I, G: H, $Top: 0, $Left: 0, Rd: "block", Ob: "absolute" };
        P = m.$SlideSpacing;
        nb = I + P;
        ob = H + P;
        F = S & 1 ? nb : ob;
